...
class TemaPage {
  static ThemeData tema = ThemeData(
    primaryColor: Colors.blue, // Uygulamanın başlık çubuğu, düğmeler ve sekmelerin rengi olarak kullanılır.
    ...
    fontFamily: 'Roboto', // Yazı tiplerini belirler, örneğin başlık, düğme veya metin stillerinde kullanılır.
